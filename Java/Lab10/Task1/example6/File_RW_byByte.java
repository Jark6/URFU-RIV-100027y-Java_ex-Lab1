...
public class File_RW_byByte {
    public static void main(String[] args) throws IOException {
        ...
        try {
            in = new FileReader("src\\Task1\\example6\\MyFile1.txt"); // файл для чтения
            out= new FileWriter("src\\Task1\\example6\\MyFile2.txt", true); // файл для записи
